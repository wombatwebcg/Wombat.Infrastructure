        ...
        public class VerifyCodeFactory
        {
            ...
            public byte[] CreateValidateGraphic(string validateCode, float fontsize, int height)
            {
                ...
                try
                {
                    ...
                    StringFormat DataFormat = new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center };
                    g.DrawString(validateCode, font, brush, layoutRectange, DataFormat);
